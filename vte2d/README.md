...
The method used is described in [my notes](https://bitbucket.org/cpraveen/www/downloads/vte2d.pdf). There is a Julia version [here](https://github.com/cpraveen/numpde/tree/master/vte2d) but it may not be as good as the Chapel version.
...
If you want to run with a single locale, then there is no need to use `stencilDist`. You can declare a normal domain instead
